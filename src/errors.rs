...
impl IntoResponse for CustomError {
    fn into_response(self) -> Response {
        ...
        let (status, error_message) = match self {
            ...
            CustomError::MissingCredentials => (StatusCode::BAD_REQUEST, "認証情報が不足しています。"),
