...
function App() {
  ...
  return name ? <div className="flex flex-row h-screen antialiased text-gray-800">
      ...
      <div className="flex flex-row items-center">
        <div className="flex flex-row items-center w-full border rounded-3xl h-12 px-2">
          ...
          <div className="w-full">
            <input value={messageInput} onChange={e => setMessageInput(e.target.value)} type="text" className="border border-transparent w-full focus:outline-none text-sm h-10 flex items-center" placeholder="Type your message...." />
          </div>
        ...
        <div className="ml-6">
          <button disabled={connectionClosed} onClick={handleClickSubmitButton} className="flex items-center justify-center h-10 w-10 rounded-full bg-gray-200 hover:bg-gray-300 text-indigo-800 text-white">
    ...
    : <NameInputModal handleClickButton={handleClickButton} />
}
